  ...
  const columns = [
    {
      ...
      render: (element: string, rowData: any) => {
        return (
          <Grid container spacing={1} className={classes.gridAction}>
            <Grid item xs={6}>
              <Buttons
...

    {
      ...
      render: (info: any) => {
        ...
        if (popularity === 2) {
          return <Tag color={"green"}>Populaire</Tag>;
        } else {
          return <Tag color={"geekblue"}>En cours</Tag>;
        }
      },
    },
    {
      ...
      render: (info: any) => {
        ...
        return (
          <p>
            {format(new Date(registerDate), "dd/MM/yyyy")} à{" "}
            {format(new Date(registerDate), "HH:mm")}
          </p>
        );
      },
    },
                    ...
                    <Grid container spacing={1} style={{ padding: 10 }}>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            {categorieActualities.map((value) => (
