    ...
    <div>
      ...
      <div className="content-home">
        <Routes>
          ...
          {/* Route Supper Admin */}
          <Route path={"/mobilepayement"} element={<MobilePayement />} />{" "}
          {/* Route Supper Admin */}
          <Route path={"/actuality"} element={<DashboardAdmin />} />{" "}
          {/* Route Admin Actualite */}
          <Route path={"/deals"} element={<DashbordAdminDeals />} />{" "}
          {/* Route Admin Deals */}
          <Route path={"/dealsEmployer"} element={<EmployerDash />} />{" "}
          {/* Route employer Deals */}
          <Route path={"/covoiturage"} element={<AdminCovoiturage />} />{" "}
          {/* Route Admin Covoiturage */}
          <Route path={"/actualityEmployer"} element={<AddActuality />} />
          {/* Route employer Actualite */}
          <Route
            path={"/covoiturageEmployer"}
            element={<EmployerCovoiturage />}
          />
          {/* Route employer Actualite */}
