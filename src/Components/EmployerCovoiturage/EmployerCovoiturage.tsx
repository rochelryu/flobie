...
function EmployerCovoiturage(props: Props) {
                            ...
                            <Grid item xs={4}>
                                <Cards
                                    ...
                                    cover={<img
                                      ...
                                      />}
                                    description={`N°: ${traveller.numero}\nPosition ${traveller.position ?? 'N/A'},`}
                                />
                            </Grid>
                            <Grid item xs={6}>
                                <div className={classes.column}>
                                    <Typography className={classes.secondaryHeading}>Pièce</Typography>
                                </div>
    ...
    const loadData = async () => {
      ...
      if(data.etat === Etat.SUCCESS) {
        const resultTravellersDemandes = data.result.allTravellersPassagers as any[];
